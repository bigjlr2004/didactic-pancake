...
namespace NinetiesTV
{
    class Program
    {
        ...
        **************************************************************************************************/
        ...
        {
            List<string> a = shows.Select(s => s.Name).ToList();
            List<string> b = a.OrderBy(s => s).ToList();
            return b;
        }
